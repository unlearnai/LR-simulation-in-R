...
load('/Users/liyunfan/Documents/Simulation_logistic/trteffect-simulation-results/logistic_trt_base.RData')
...
save(true_OR, true_RR, true_RD, est_original, OR_unadj_ci, RR_unadj_ci, RD_unadj_ci,
     OR_adj_ci, RR_adj_ci, RD_adj_ci, p0_var, p0_mean, file = "logistic_trt_base.RData")
