...
# Unbalanced design, equal reduction in each arm

rm(list=ls())
setwd('/Users/liyunfan/Documents/Simulation_logistic')

# load("logistic_demo_unbalanced.RData")
...
save.image(file = "logistic_demo_unbalanced.RData")
